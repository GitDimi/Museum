...
//Pin de sortie
  ...
  #define Pin_Lumiere 5
  #define Pin_Musique1 6
  #define Pin_Musique2 7
  #define Pin_Musique3 8
  #define Pin_Diffuseur 9
  #define Pin_Souffle 10
  #define Pin_Ventilateur 11
  #define Pin_Deshumidificateur 12
  #define Pin_LED 13
